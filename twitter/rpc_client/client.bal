...
public isolated client class Client {
    ...
    remote isolated function listBatchComplianceJobs("tweets"|"users" 'type, "created"|"in_progress"|"failed"|"complete"? status = (), ("created_at"|"download_expires_at"|"download_url"|"id"|"name"|"resumable"|"status"|"type"|"upload_expires_at"|"upload_url")[]? compliance_jobFields = ()) returns Get2ComplianceJobsResponse|error {
    ...
    #
    # + return - The request has succeeded. 
    remote isolated function createBatchComplianceJob(CreateComplianceJobRequest payload) returns CreateComplianceJobResponse|error {
        string resourcePath = string `/2/compliance/jobs`;
    ...
    # + compliance_jobFields - A comma separated list of ComplianceJob fields to display.
    # + return - The request has succeeded. 
    remote isolated function getBatchComplianceJob(JobId id, ("created_at"|"download_expires_at"|"download_url"|"id"|"name"|"resumable"|"status"|"type"|"upload_expires_at"|"upload_url")[]? compliance_jobFields = ()) returns Get2ComplianceJobsIdResponse|error {
    ...
    #
    # + return - The request has succeeded. 
    remote isolated function dmConversationIdCreate(CreateDmConversationRequest payload) returns CreateDmEventResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function dmConversationWithUserEventIdCreate(UserId participant_id, CreateMessageRequest payload) returns CreateDmEventResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function dmConversationByIdEventIdCreate(string dm_conversation_id, CreateMessageRequest payload) returns CreateDmEventResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function getDmConversationsIdDmEvents(DmConversationId id, int:Signed32 max_results = 100, PaginationToken32? pagination_token = (), ("MessageCreate"|"ParticipantsJoin"|"ParticipantsLeave")[] event_types = ["MessageCreate","ParticipantsLeave","ParticipantsJoin"], ("attachments"|"created_at"|"dm_conversation_id"|"event_type"|"id"|"participant_ids"|"referenced_tweets"|"sender_id"|"text")[]? dm_eventFields = (), ("attachments.media_keys"|"participant_ids"|"referenced_tweets.id"|"sender_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2DmConversationsIdDmEventsResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function getDmEvents(int:Signed32 max_results = 100, PaginationToken32? pagination_token = (), ("MessageCreate"|"ParticipantsJoin"|"ParticipantsLeave")[] event_types = ["MessageCreate","ParticipantsLeave","ParticipantsJoin"], ("attachments"|"created_at"|"dm_conversation_id"|"event_type"|"id"|"participant_ids"|"referenced_tweets"|"sender_id"|"text")[]? dm_eventFields = (), ("attachments.media_keys"|"participant_ids"|"referenced_tweets.id"|"sender_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2DmEventsResponse|error {
    ...
    #
    # + return - The request has succeeded. 
    remote isolated function listIdCreate(ListCreateRequest payload) returns ListCreateResponse|error {
    ...
    # + userFields - A comma separated list of User fields to display.
    # + return - The request has succeeded. 
    remote isolated function listIdGet(ListId id, ("created_at"|"description"|"follower_count"|"id"|"member_count"|"name"|"owner_id"|"private")[]? listFields = (), ("owner_id")[]? expansions = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = ()) returns Get2ListsIdResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function listIdUpdate(ListId id, ListUpdateRequest payload) returns ListUpdateResponse|error {
        string resourcePath = string `/2/lists/${getEncodedUri(id)}`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - The request has succeeded. 
    remote isolated function listIdDelete(ListId id) returns ListDeleteResponse|error {
        string resourcePath = string `/2/lists/${getEncodedUri(id)}`;
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function listGetMembers(ListId id, int:Signed32 max_results = 100, PaginationTokenLong? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2ListsIdMembersResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function listAddMember(ListId id, ListAddUserRequest payload) returns ListMutateResponse|error {
        string resourcePath = string `/2/lists/${getEncodedUri(id)}/members`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - The request has succeeded. 
    remote isolated function listRemoveMember(ListId id, UserId user_id) returns ListMutateResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function findSpacesByIds(string[] ids, ("created_at"|"creator_id"|"ended_at"|"host_ids"|"id"|"invited_user_ids"|"is_ticketed"|"lang"|"participant_count"|"scheduled_start"|"speaker_ids"|"started_at"|"state"|"subscriber_count"|"title"|"topic_ids"|"updated_at")[]? spaceFields = (), ("creator_id"|"host_ids"|"invited_user_ids"|"speaker_ids"|"topic_ids")[]? expansions = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("description"|"id"|"name")[]? topicFields = ()) returns Get2SpacesResponse|error {
    ...
    # + topicFields - A comma separated list of Topic fields to display.
    # + return - The request has succeeded. 
    remote isolated function findSpacesByCreatorIds(UserId[] user_ids, ("created_at"|"creator_id"|"ended_at"|"host_ids"|"id"|"invited_user_ids"|"is_ticketed"|"lang"|"participant_count"|"scheduled_start"|"speaker_ids"|"started_at"|"state"|"subscriber_count"|"title"|"topic_ids"|"updated_at")[]? spaceFields = (), ("creator_id"|"host_ids"|"invited_user_ids"|"speaker_ids"|"topic_ids")[]? expansions = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("description"|"id"|"name")[]? topicFields = ()) returns Get2SpacesByCreatorIdsResponse|error {
    ...
    # + topicFields - A comma separated list of Topic fields to display.
    # + return - The request has succeeded. 
    remote isolated function searchSpaces(string query, "live"|"scheduled"|"all" state = "all", int:Signed32 max_results = 100, ("created_at"|"creator_id"|"ended_at"|"host_ids"|"id"|"invited_user_ids"|"is_ticketed"|"lang"|"participant_count"|"scheduled_start"|"speaker_ids"|"started_at"|"state"|"subscriber_count"|"title"|"topic_ids"|"updated_at")[]? spaceFields = (), ("creator_id"|"host_ids"|"invited_user_ids"|"speaker_ids"|"topic_ids")[]? expansions = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("description"|"id"|"name")[]? topicFields = ()) returns Get2SpacesSearchResponse|error {
    ...
    # + topicFields - A comma separated list of Topic fields to display.
    # + return - The request has succeeded. 
    remote isolated function findSpaceById(string id, ("created_at"|"creator_id"|"ended_at"|"host_ids"|"id"|"invited_user_ids"|"is_ticketed"|"lang"|"participant_count"|"scheduled_start"|"speaker_ids"|"started_at"|"state"|"subscriber_count"|"title"|"topic_ids"|"updated_at")[]? spaceFields = (), ("creator_id"|"host_ids"|"invited_user_ids"|"speaker_ids"|"topic_ids")[]? expansions = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("description"|"id"|"name")[]? topicFields = ()) returns Get2SpacesIdResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function spaceTweets(string id, int:Signed32 max_results = 100, ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2SpacesIdTweetsResponse|error {
    ...
    #
    # + return - The request has succeeded. 
    remote isolated function createTweet(TweetCreateRequest payload) returns TweetCreateResponse|error {
        string resourcePath = string `/2/tweets`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - The request has succeeded. 
    remote isolated function getTweetsComplianceStream(int:Signed32 partition, int:Signed32? backfill_minutes = (), string? start_time = (), string? end_time = ()) returns TweetComplianceStreamResponse|error {
    ...
    # + search_countFields - A comma separated list of SearchCount fields to display.
    # + return - The request has succeeded. 
    remote isolated function tweetCountsRecentSearch(string query, string? start_time = (), string? end_time = (), TweetId? since_id = (), TweetId? until_id = (), PaginationToken36? next_token = (), PaginationToken36? pagination_token = (), "minute"|"hour"|"day" granularity = "hour", ("end"|"start"|"tweet_count")[]? search_countFields = ()) returns Get2TweetsCountsRecentResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function getTweetsFirehoseStream(int:Signed32 partition, int:Signed32? backfill_minutes = (), string? start_time = (), string? end_time = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns StreamingTweetResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function getTweetsLabelStream(int:Signed32? backfill_minutes = (), string? start_time = (), string? end_time = ()) returns TweetLabelStreamResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function sampleStream(int:Signed32? backfill_minutes = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns StreamingTweetResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function getTweetsSample10Stream(int:Signed32 partition, int:Signed32? backfill_minutes = (), string? start_time = (), string? end_time = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2TweetsSample10StreamResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function tweetsFullarchiveSearch(string query, string? start_time = (), string? end_time = (), TweetId? since_id = (), TweetId? until_id = (), int:Signed32 max_results = 10, PaginationToken36? next_token = (), PaginationToken36? pagination_token = (), "recency"|"relevancy"? sort_order = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2TweetsSearchAllResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function tweetsRecentSearch(string query, string? start_time = (), string? end_time = (), TweetId? since_id = (), TweetId? until_id = (), int:Signed32 max_results = 10, PaginationToken36? next_token = (), PaginationToken36? pagination_token = (), "recency"|"relevancy"? sort_order = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2TweetsSearchRecentResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function searchStream(int:Signed32? backfill_minutes = (), string? start_time = (), string? end_time = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns FilteredStreamingTweetResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function getRules(RuleId[]? ids = (), int:Signed32 max_results = 1000, string? pagination_token = ()) returns RulesLookupResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function addOrDeleteRules(AddOrDeleteRulesRequest payload, boolean? dry_run = ()) returns AddOrDeleteRulesResponse|error {
        string resourcePath = string `/2/tweets/search/stream/rules`;
    ...
    # + return - The request has succeeded. 
    remote isolated function deleteTweetById(TweetId id) returns TweetDeleteResponse|error {
        string resourcePath = string `/2/tweets/${getEncodedUri(id)}`;
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function tweetsIdLikingUsers(TweetId id, int:Signed32 max_results = 100, PaginationToken36? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2TweetsIdLikingUsersResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function findTweetsThatQuoteATweet(TweetId id, int:Signed32 max_results = 10, PaginationToken36? pagination_token = (), ("replies"|"retweets")[]? exclude = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2TweetsIdQuoteTweetsResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function tweetsIdRetweetingUsers(TweetId id, int:Signed32 max_results = 100, PaginationToken36? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2TweetsIdRetweetedByResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function hideReplyById(TweetId tweet_id, TweetHideRequest payload) returns TweetHideResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function findUsersById(UserId[] ids, ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function findUsersByUsername(string[] usernames, ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersByResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function findUserByUsername(string username, ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersByUsernameUsernameResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function getUsersComplianceStream(int:Signed32 partition, int:Signed32? backfill_minutes = (), string? start_time = (), string? end_time = ()) returns UserComplianceStreamResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function findMyUser(("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersMeResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function findUserById(UserId id, ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersIdResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function usersIdBlocking(UserIdMatchesAuthenticatedUser id, int:Signed32? max_results = (), PaginationToken32? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersIdBlockingResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdBlock(UserIdMatchesAuthenticatedUser id, BlockUserRequest payload) returns BlockUserMutationResponse|error {
        string resourcePath = string `/2/users/${getEncodedUri(id)}/blocking`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function getUsersIdBookmarks(UserIdMatchesAuthenticatedUser id, int:Signed32? max_results = (), PaginationToken36? pagination_token = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2UsersIdBookmarksResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function postUsersIdBookmarks(UserIdMatchesAuthenticatedUser id, BookmarkAddRequest payload) returns BookmarkMutationResponse|error {
        string resourcePath = string `/2/users/${getEncodedUri(id)}/bookmarks`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdBookmarksDelete(UserIdMatchesAuthenticatedUser id, TweetId tweet_id) returns BookmarkMutationResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function listUserFollow(UserIdMatchesAuthenticatedUser id, ListFollowedRequest payload) returns ListFollowedResponse|error {
        string resourcePath = string `/2/users/${getEncodedUri(id)}/followed_lists`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - The request has succeeded. 
    remote isolated function listUserUnfollow(UserIdMatchesAuthenticatedUser id, ListId list_id) returns ListFollowedResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function usersIdFollowers(UserId id, int:Signed32? max_results = (), PaginationToken32? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersIdFollowersResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function usersIdFollowing(UserId id, int:Signed32? max_results = (), PaginationToken32? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersIdFollowingResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdFollow(UserIdMatchesAuthenticatedUser id, UsersFollowingCreateRequest payload) returns UsersFollowingCreateResponse|error {
        string resourcePath = string `/2/users/${getEncodedUri(id)}/following`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function usersIdLikedTweets(UserId id, int:Signed32? max_results = (), PaginationToken36? pagination_token = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2UsersIdLikedTweetsResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdLike(UserIdMatchesAuthenticatedUser id, UsersLikesCreateRequest payload) returns UsersLikesCreateResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdUnlike(UserIdMatchesAuthenticatedUser id, TweetId tweet_id) returns UsersLikesDeleteResponse|error {
    ...
    # + tweetFields - A comma separated list of Tweet fields to display.
    # + return - The request has succeeded. 
    remote isolated function usersIdMuting(UserIdMatchesAuthenticatedUser id, int:Signed32 max_results = 100, PaginationTokenLong? pagination_token = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("pinned_tweet_id")[]? expansions = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = ()) returns Get2UsersIdMutingResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdMute(UserIdMatchesAuthenticatedUser id, MuteUserRequest payload) returns MuteUserMutationResponse|error {
        string resourcePath = string `/2/users/${getEncodedUri(id)}/muting`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + userFields - A comma separated list of User fields to display.
    # + return - The request has succeeded. 
    remote isolated function listUserPinnedLists(UserIdMatchesAuthenticatedUser id, ("created_at"|"description"|"follower_count"|"id"|"member_count"|"name"|"owner_id"|"private")[]? listFields = (), ("owner_id")[]? expansions = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = ()) returns Get2UsersIdPinnedListsResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function listUserPin(UserIdMatchesAuthenticatedUser id, ListPinnedRequest payload) returns ListPinnedResponse|error {
        string resourcePath = string `/2/users/${getEncodedUri(id)}/pinned_lists`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - The request has succeeded. 
    remote isolated function listUserUnpin(UserIdMatchesAuthenticatedUser id, ListId list_id) returns ListUnpinResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdRetweets(UserIdMatchesAuthenticatedUser id, UsersRetweetsCreateRequest payload) returns UsersRetweetsCreateResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdUnretweets(UserIdMatchesAuthenticatedUser id, TweetId source_tweet_id) returns UsersRetweetsDeleteResponse|error {
    ...
    # + placeFields - A comma separated list of Place fields to display.
    # + return - The request has succeeded. 
    remote isolated function usersIdTweets(UserId id, TweetId? since_id = (), TweetId? until_id = (), int:Signed32? max_results = (), PaginationToken36? pagination_token = (), ("replies"|"retweets")[]? exclude = (), string? start_time = (), string? end_time = (), ("attachments"|"author_id"|"context_annotations"|"conversation_id"|"created_at"|"edit_controls"|"edit_history_tweet_ids"|"entities"|"geo"|"id"|"in_reply_to_user_id"|"lang"|"non_public_metrics"|"organic_metrics"|"possibly_sensitive"|"promoted_metrics"|"public_metrics"|"referenced_tweets"|"reply_settings"|"source"|"text"|"withheld")[]? tweetFields = (), ("attachments.media_keys"|"attachments.poll_ids"|"author_id"|"edit_history_tweet_ids"|"entities.mentions.username"|"geo.place_id"|"in_reply_to_user_id"|"referenced_tweets.id"|"referenced_tweets.id.author_id")[]? expansions = (), ("alt_text"|"duration_ms"|"height"|"media_key"|"non_public_metrics"|"organic_metrics"|"preview_image_url"|"promoted_metrics"|"public_metrics"|"type"|"url"|"variants"|"width")[]? mediaFields = (), ("duration_minutes"|"end_datetime"|"id"|"options"|"voting_status")[]? pollFields = (), ("created_at"|"description"|"entities"|"id"|"location"|"name"|"pinned_tweet_id"|"profile_image_url"|"protected"|"public_metrics"|"url"|"username"|"verified"|"verified_type"|"withheld")[]? userFields = (), ("contained_within"|"country"|"country_code"|"full_name"|"geo"|"id"|"name"|"place_type")[]? placeFields = ()) returns Get2UsersIdTweetsResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdUnblock(UserIdMatchesAuthenticatedUser source_user_id, UserId target_user_id) returns BlockUserMutationResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdUnfollow(UserIdMatchesAuthenticatedUser source_user_id, UserId target_user_id) returns UsersFollowingDeleteResponse|error {
    ...
    # + return - The request has succeeded. 
    remote isolated function usersIdUnmute(UserIdMatchesAuthenticatedUser source_user_id, UserId target_user_id) returns MuteUserMutationResponse|error {
